...
import 'package:fast_app_base/common/hooks/use_second_timer.dart';
...
class WriteTodoDialog extends HookConsumerDialogWidget<WriteTodoResult> {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // final object = Todo(id: 1, title: 'yes', dueDate: DateTime.now());
    // print('object: ${object.hashCode}');

    final object = useMemoized(() => Todo(id: 1, title: 'yes', dueDate: DateTime.now()));
    print('object: ${object.hashCode}');
